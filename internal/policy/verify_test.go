...
// 		status := VerifyTag(testCtx, repo, []string{tagID.String()})
// 		assert.Equal(t, expectedStatus, status)
...
// 		status = VerifyTag(testCtx, repo, []string{tagName})
// 		assert.Equal(t, expectedStatus, status)
...
// 		status = VerifyTag(testCtx, repo, []string{string(plumbing.NewTagReferenceName(tagName))})
// 		assert.Equal(t, expectedStatus, status)
// 	})
